...
export interface TimelockInterface extends utils.Interface {
  functions: {
    ...
    "setFeeAdmin(address,address)": FunctionFragment;
    "setFees(address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bool)": FunctionFragment;
    "setFlpCooldownDuration(uint256)": FunctionFragment;
    ...
    "setReferralManager(address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setFlpCooldownDuration",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
