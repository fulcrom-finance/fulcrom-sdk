...
import type { VaultV2b, VaultV2bInterface } from "../VaultV2b";
...
export class VaultV2b__factory {
  static readonly abi = _abi;
  static createInterface(): VaultV2bInterface {
    return new utils.Interface(_abi) as VaultV2bInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VaultV2b {
    return new Contract(address, _abi, signerOrProvider) as VaultV2b;
  }
}
