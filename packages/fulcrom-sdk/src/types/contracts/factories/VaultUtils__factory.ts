...
import type { VaultUtils, VaultUtilsInterface } from "../VaultUtils";
...
const _abi = [
    ...
    outputs: [
      {
        ...
        internalType: "struct IVaultUtils.Position",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    name: "validateLiquidationForBot",
    outputs: [
      {
        internalType: "uint256",
        name: "",
...
export class VaultUtils__factory {
