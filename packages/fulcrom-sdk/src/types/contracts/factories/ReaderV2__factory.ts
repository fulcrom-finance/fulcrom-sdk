...
import type { ReaderV2, ReaderV2Interface } from "../ReaderV2";
...
export class ReaderV2__factory {
  static readonly abi = _abi;
  static createInterface(): ReaderV2Interface {
    return new utils.Interface(_abi) as ReaderV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ReaderV2 {
    return new Contract(address, _abi, signerOrProvider) as ReaderV2;
  }
}
